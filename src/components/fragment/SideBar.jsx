    ...
    return (
        <aside style={useStyle.component} className={"aside-bar"}>
            ...
            <div className="aside-bar-container playlist">
                ...
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/HINDI"}  title={"HINDI"}/>
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/TELUGU"}  title={"TELUGU"}/>
            </div>
        </aside>
    );
}
